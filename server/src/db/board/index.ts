...
export interface IdeaBoard { // TODO replace this interface with a board entity subClass
  ...
  accessLink: string;
  readOnly: boolean;
  owners: IdeaBoardUser[]; // TODO type this with user subClass entity
  guests: IdeaBoardUser[]; // TODO type this with user subClass entity
  ideas: any[]; // TODO Replace with a real entity class
}
